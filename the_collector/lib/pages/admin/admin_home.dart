...
class TheAdminHomePage extends StatefulWidget {
  const TheAdminHomePage({super.key, required this.themeNotifier});

  final ValueNotifier<ThemeMode> themeNotifier;

  @override
  State<TheAdminHomePage> createState() => _TheAdminHomePageState();
}

class _TheAdminHomePageState extends State<TheAdminHomePage> {
  int _currentIndex = 0;
